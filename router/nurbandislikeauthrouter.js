...
router.post('/', async (req, res) => {
    ...
    try{
        ...
        nurbanDislikeResult = await totalDislikeDao.create(articleId, userId);
...
router.delete('/', async (req, res) => {
    ...
    let nurbanDislikeResult;
    try{
        //nurbanDislikeResult = await nurbanDislikeDao.destroyUserId(articleId, userId);
        nurbanDislikeResult = await totalDislikeDao.destroyUserId(articleId, userId);
