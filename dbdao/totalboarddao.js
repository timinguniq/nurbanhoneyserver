...
exports.readForUserId = function read(userId, offset = 0, limit = 10){
    return TotalBoard.findAll({
        attributes: ['id', 'board', 'thumbnail', 'title', 'count', 'commentCount', 'createdAt'],
...
exports.readNurban = function read(articleId = -1, limit = 10){
    return articleId == -1 ? TotalBoard.findAll({
        ...
        attributes: ['id', 'thumbnail', 'lossCut', 'title', 'content', 'commentCount', 'likeCount', 'createdAt'],
        limit: Number(limit),
        order: [['id', 'DESC']],
        where: {
            id: {
...
exports.readFree = function read(articleId = -1, limit = 10){
    return articleId == -1 ? TotalBoard.findAll({
        ...
        attributes: ['id', 'thumbnail', 'title', 'lossCut', 'content', 'commentCount', 'likeCount', 'createdAt'],
        limit: Number(limit),
        order: [['id', 'DESC']],
        where: {
            id: {
